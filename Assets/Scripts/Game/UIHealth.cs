...
using UnityEngine.UI;
	...
	public class UIHealth : MonoBehaviour
	{
		...
		public void UpdateHealth(LifeHandler health)
		{

			int currentHealth = Mathf.CeilToInt(health._currentLife);
			...
			float progress = health._currentLife /LifeHandler.MAX_LIFE;
